...
| `tickets.html` | 票券（晴空塔 QR + NEX 換票資訊）**已加密，需密碼；不在導覽中** |
...
**票券頁刻意不放進底部導覽**：不是每個家人都需要看到票券，
所以三頁的導覽只有「行程／地圖／行李」，票券要自己輸入網址或存書籤才進得去
（票券頁本身保留三格導覽，隨時能回到其他頁）。
注意這只是「不主動展示」，repo 是公開的、檔案清單看得到，真正保護內容的是密碼。
